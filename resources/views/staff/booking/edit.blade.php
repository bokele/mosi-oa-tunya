<x-app-layout>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="status" id="status" placeholder="{{ __('Title') }}" class="form-control {{ $errors->has('user') ? 'is-invalid' : ''
                                                ...
                                                <option value="attended" @if ($booking->status == 'attended' )
                                                    {{'selected'}}
                                                    @endif>Attended</option>
                                                <option value="cancel" @if ($booking->status == 'cancel' )
                                                    {{'selected'}}
                                                    @endif>Cancel</option>
                                                <option value="waiting" @if ($booking->status == 'waiting' )
                                                    {{'selected'}}
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="hidden" name="come_into_office" id="hidden_come_into_office"
                                        value="{{$booking->come_into_office}}" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="staff_comment" id="staff_comment"
                                            ...
                                            class="form-control {{ $errors->has('staff_comment') ? 'is-invalid' : ''
                                                                                }}  summernote">{{$booking->staff_comment}}</textarea>
                                        <span class="invalid-feedback d-block" role="alert">
    ...
    <script>
        $(document).ready(function(){
            @if ($booking->come_into_office == 'yes')
                $('#come_into_office').prop('checked')
                $('#hidden_come_into_office').val('yes');
            @else
                $('#come_into_office').removeAttr('checked');
