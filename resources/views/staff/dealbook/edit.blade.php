<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <div class="col-sm-6">
            <h1 class="m-0 text-dark font-weight-bold">{{ __('Edit DealBook') }}</h1>
        </div>
        <!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="col-md-12">
            <section class="content">
                <div class="card card-blue">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('admin.dealbooks.update', $dealbook->id) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="content" id="summernote" placeholder="{{ __('content') }}"
                                            class="form-control {{ $errors->has('content') ? 'is-invalid' : ''
                                                }} " value="{{ $dealbook->content}}">{{ $dealbook->content}}</textarea>
